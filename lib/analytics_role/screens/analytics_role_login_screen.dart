...
class AnalyticsRoleLoginScreen extends ConsumerStatefulWidget {
  const AnalyticsRoleLoginScreen({super.key});

  @override
  ConsumerState<AnalyticsRoleLoginScreen> createState() =>
      _AnalyticsRoleLoginScreenState();
}

class _AnalyticsRoleLoginScreenState
    extends ConsumerState<AnalyticsRoleLoginScreen> {
  ...
  Widget build(BuildContext context) {
    final isLoading = ref.watch(analyticsRoleLoginLoadingStateProvider);
    final obscurePassword =
        ref.watch(analyticsRoleLoginObscurePasswordStateProvider);
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'analytics@example.com',
