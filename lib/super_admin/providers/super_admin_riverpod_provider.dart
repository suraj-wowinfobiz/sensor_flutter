...
final devicesProvider = FutureProvider.autoDispose.family<List<Device>, int>((ref, _) async {
...
final sensorsProvider = FutureProvider.autoDispose.family<List<Sensor>, int>((ref, _) async {
  final backend = ref.read(superAdminBackendChangeNotifierProvider);
