...
import '../providers/vendor_api_riverpod_provider.dart';
...
class VendorDashboardScreen extends ConsumerStatefulWidget {
  ...
  const VendorDashboardScreen({super.key, this.embeddedScroll = false});
...
class _VendorDashboardScreenState extends ConsumerState<VendorDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final statsApi = ref.watch(vendorDashboardStatsApiProvider).valueOrNull;
    ...
    final content = Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildLiveSeriesCard(
            context,
            title: 'Support Alert Severity Trend',
  ...
  Widget _buildTopStats(
    ...
    final cards = [
      _MetricData(
        ...
        subtitle: '$activeOrganizationsCount active client accounts',
        icon: Icons.business,
      ...
      _MetricData(
        ...
        subtitle: 'Vendor-managed installation footprint',
    ...
    return _DashboardPanel(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Daily incident pressure across vendor-managed client deployments.',
    ...
    return _DashboardPanel(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Daily growth in vendor users and client sites.',
            style: TextStyle(fontSize: 12, color: _mutedTextColor(context)),
          ),
          const SizedBox(height: 12),
          SizedBox(
          ...
          const Wrap(
            ...
            children: [
              ...
              _LegendItem(color: Color(0xFFEF4444), label: 'New sites'),
            ],
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _valueChip(context, 'Clients', organizations.toStringAsFixed(0)),
  ...
  Widget _statusDistributionCard(BuildContext context, dynamic db) {
    ...
    return _DashboardPanel(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _panelTitle(context, 'Team Role Distribution', Icons.memory_outlined),
          const SizedBox(height: 8),
          SizedBox(
            height: 280,
            child: PieChart(
  ...
  Widget _tiltPatternCard(BuildContext context) {
    ...
    return _DashboardPanel(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _panelTitle(context, 'Alerts Per Client', Icons.show_chart),
          const SizedBox(height: 4),
          Text(
            'Incident concentration by client account.',
            style: TextStyle(fontSize: 12, color: _mutedTextColor(context)),
          ),
          const SizedBox(height: 8),
          SizedBox(
    ...
    return _DashboardPanel(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Coverage of open incidents mapped to asset hierarchy and client ownership.',
            style: TextStyle(fontSize: 12, color: _mutedTextColor(context)),
          ),
          const SizedBox(height: 8),
          SizedBox(
  ...
  Widget _buildScatterCard(BuildContext context) {
    ...
    return _DashboardPanel(
      child: Column(
        ...
        children: [
          _panelTitle(
              context, 'Client Site/Device Correlation', Icons.multiline_chart),
          const SizedBox(height: 8),
          SizedBox(
            height: 300,
            child: ScatterChart(
            ...
            child: Container(
              ...
              child: DataTable(
                ...
                columns: [
                  ...
                  _tableHeading(context, 'Client / Site'),
  ...
  Widget _buildBottomLiveStats(BuildContext context, dynamic db) {
    ...
    final cards = [
      _MiniStatData(
        ...
        unit: 'clients',
        detail: 'of ${(db.organizations as List).length} total clients',
      ...
      _MiniStatData(
        ...
        unit: '',
        detail: 'most recent client incident',
    ...
    return _DashboardPanel(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Breakdown of client incidents by current severity state.',
            style: TextStyle(fontSize: 12, color: _mutedTextColor(context)),
          ),
          const SizedBox(height: 12),
    ...
    return _DashboardPanel(
      child: Column(
        ...
        children: [
          _panelTitle(
            context,
            'Top Clients By Open Alerts',
            Icons.leaderboard_outlined,
          ),
          const SizedBox(height: 10),
          Text(
            'Client accounts needing immediate vendor response.',
            style: TextStyle(fontSize: 12, color: _mutedTextColor(context)),
          ),
          const SizedBox(height: 12),
          if (topOrgs.isEmpty)
            Padding(
              ...
              child: Center(
                child: Text(
                  'No active client alerts available.',
                  style: TextStyle(color: _mutedTextColor(context)),
                ),
              ),
            )
