...
class ApiClient {
  ...
  static const String baseUrl = VendorApiConfig.baseUrl;
  static const String _tokenStorageKey = 'vendor_auth_token';
  ...
  static Future<ApiEnvelope> put(
    ...
    await _ensureTokenLoaded();
    final response = await _dio
        .put<dynamic>(path, data: data, queryParameters: queryParameters)
        .timeout(_requestDeadline);
    return ApiEnvelope.fromResponse(response.data);
  }
  ...
  static Future<ApiEnvelope> delete(
    ...
    await _ensureTokenLoaded();
    final response = await _dio
        .delete<dynamic>(path, data: data, queryParameters: queryParameters)
        .timeout(_requestDeadline);
    return ApiEnvelope.fromResponse(response.data);
  }
}
