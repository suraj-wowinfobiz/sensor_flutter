...
class OrgServiceApi {
  static const String baseUrl = '${VendorApiConfig.baseUrl}/api/v1/org';
  ...
  static Future<ApiResponse> updateZone(
    String zoneId,
    String name, {
    String? siteId,
  }) async {
  ...
  static Future<http.Response> _send(Future<http.Response> request) async {
    try {
      ...
      throw ApiException('Connection timeout. Check if backend is running.');
