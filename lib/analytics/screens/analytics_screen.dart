...
class _AnalyticsScreenState extends ConsumerState<AnalyticsScreen>
  ...
  List<UserNotificationItem> _notifications() {
    final db = ref.read(analyticsDatabaseChangeNotifierProvider);
      ...
      bottomNavigationBar: isDesktop
          ...
          : AnimatedSwitcher(
              ...
              child: _showBottomNav
                  ? KeyedSubtree(
                      key: const ValueKey('analytics-bottom-nav-visible'),
                  ...
                  : const SizedBox.shrink(
                      key: ValueKey('analytics-bottom-nav-hidden'),
                    ),
            ),
    );
  }
  ...
  Widget _buildView(String view) {
    switch (view) {
      ...
      case 'settings':
        return const AnalyticsSettingsScreen();
      default:
        return const AnalyticsDashboardScreen();
    }
  }
      ...
      children: _openedViews
          .map(
            (openedView) => KeyedSubtree(
              key: PageStorageKey<String>('analytics_$openedView'),
