...
class AnalyticsLoginScreen extends ConsumerStatefulWidget {
  const AnalyticsLoginScreen({super.key});

  @override
  ConsumerState<AnalyticsLoginScreen> createState() =>
      _AnalyticsLoginScreenState();
}

class _AnalyticsLoginScreenState extends ConsumerState<AnalyticsLoginScreen> {
