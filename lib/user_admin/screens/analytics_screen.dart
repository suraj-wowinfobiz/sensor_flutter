...
class UserAdminAnalyticsScreen extends StatefulWidget {
  const UserAdminAnalyticsScreen({super.key});

  @override
  State<UserAdminAnalyticsScreen> createState() =>
      _UserAdminAnalyticsScreenState();
}

class _UserAdminAnalyticsScreenState extends State<UserAdminAnalyticsScreen> {
                                  ...
                                  if (_compareMode != 'none')
                                    LineChartBarData(
                                      spots: List.generate(40, (i) {
                                        ...
                                        return FlSpot(
                                          i.toDouble(),
                                          selected.lastReading + offset + noise,
                                        );
                                      }),
                                      isCurved: true,
