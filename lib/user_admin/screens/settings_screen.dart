...
class UserAdminSettingsScreen extends StatefulWidget {
  const UserAdminSettingsScreen({super.key});

  @override
  State<UserAdminSettingsScreen> createState() =>
      _UserAdminSettingsScreenState();
}

class _UserAdminSettingsScreenState extends State<UserAdminSettingsScreen> {
  ...
  void initState() {
    super.initState();
    final db = Provider.of<UserAdminDatabaseProvider>(context, listen: false);
